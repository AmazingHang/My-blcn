...
namespace ns3
{
  int main(int argc, char *argv[])
  {
    ...
    topologyReader.SetFileName("/home/ndnSIM/t-blockNDN-v2/topology/ws25wD.txt");
    topologyReader.Read();
    ...
    for (int i = 0; i < 25; i++)
    {
      ...
      Simulator::Schedule(Seconds(1.000), &ndnBlockchainApp::makeBlockchain, apps[i], 80);
    }

    Simulator::Schedule(Seconds(2.0), &ndnBlockchainApp::pullUpdateBCStatus, apps[1]);
    Simulator::Schedule(Seconds(2.0), &ndnBlockchainApp::pullUpdateBCStatus, apps[5]);
    Simulator::Schedule(Seconds(2.0), &ndnBlockchainApp::pullUpdateBCStatus, apps[8]);
