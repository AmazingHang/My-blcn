...
namespace ns3
{
    int main(int argc, char *argv[])
    {
        ...
        topologyReader.SetFileName("/home/ndnSIM/t-blockNDN-v2/topology/topology100.txt");
        topologyReader.Read();
        ...
        for (int i = 0; i < 100; i++)
        {
            Simulator::Schedule(Seconds(5.000), &ndnBlockchainApp::makeBlockchain, apps[i], initVector[i]);
        }
